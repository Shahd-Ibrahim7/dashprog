 <!-- JavaScript Libraries -->
    <script src="{{ asset('dashboard/https://code.jquery.com/jquery-3.4.1.min.js')}}"></script>
    <script src="{{ asset('dashboard/https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.bundle.min.js')}}"></script>
    ...
    <script src="{{ asset('dashboard/mail/jqBootstrapValidation.min.js')}}"></script>
    <script src="{{ asset('dashboard/mail/contact.js')}}"></script>
